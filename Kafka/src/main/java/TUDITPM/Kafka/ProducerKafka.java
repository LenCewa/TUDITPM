...
public abstract class ProducerKafka extends Thread{
	...
	/**
	 * Here you specify what your producer should do, so for example
	 * check every rss message in a list (initialized in initializeNeededData())
	 * 
	 * DO NOT USE AN INFINITE LOOP BECAUSE THIS IS ALREADY HANDLED IN THE RUN METHOD
	 */
